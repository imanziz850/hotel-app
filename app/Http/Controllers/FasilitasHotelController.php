...
class FasilitasHotelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'foto' => 'required|image|mimes:png,jpg,jpeg|dimensions:min_width=1000,min_heigth=500|between:50,1000',
    ...
    public function update(Request $request, FasilitasHotel $fasilita)
    {
        $request->validate([
            'nama_fasilitas' => 'required|min:3',
            'foto' => 'nullable|image|mimes:png,jpg,jpeg|dimensions:min_width=1000,min_heigth=500|between:50,1000',
            'deskripsi' => 'required|min:10'
        ]);
